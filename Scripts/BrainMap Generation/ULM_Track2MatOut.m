...
%
% NOTE (repo integration):
% This repository includes an adapted MATLAB script `FinalImage_MAT.m` that converts the
% PINN-exported tracks (`Track_tot_1/2/3`) into the input format expected by this function.
% Please see `FinalImage_MAT.m` for usage and attribution notes.
% INPUTS:
